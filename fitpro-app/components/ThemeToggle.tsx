...
const THEMES: Array<{
  ...
  { id: 'dark', label: 'Dark', icon: 'Lua', color: '#1a1a1a', border: '#444' },
  { id: 'light', label: 'Claro', icon: 'Sol', color: '#f5f5f5', border: '#ddd' },
  { id: 'blue', label: 'Blue', icon: 'Azul', color: '#0d1b35', border: '#1e3a6e' },
]
...
export default function ThemeToggle() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="text-xs font-semibold">{current.icon}</span>
