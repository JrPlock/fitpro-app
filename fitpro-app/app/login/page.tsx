    ...
    <main className="min-h-screen flex items-center justify-center p-6"
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm" style={{ color: 'var(--text-muted)' }}>Entre na sua conta FitPro</p>
        </div>

        <div className="card p-6 space-y-4">
          <div>
            <label className="block text-xs font-semibold mb-2" style={{ color: 'var(--text-muted)' }}>E-MAIL</label>
          ...
          <div>
            <label className="block text-xs font-semibold mb-2" style={{ color: 'var(--text-muted)' }}>SENHA</label>
        ...
        <p className="text-center text-sm" style={{ color: 'var(--text-dim)' }}>
          Não tem conta?{' '}
          <Link href="/cadastro" className="font-semibold" style={{ color: 'var(--accent)' }}>Cadastre-se</Link>
        </p>
      </div>
    </main>
  )
