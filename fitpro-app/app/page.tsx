    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden"
      ...
      <div className="max-w-md w-full text-center space-y-10 relative z-10">
        ...
        <div className="space-y-3">
          ...
          <p style={{ color: 'var(--text-muted)' }} className="text-base">Plataforma completa para Personal Trainers</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <Link href="/login"
            ...
            style={{ background: 'linear-gradient(135deg, var(--accent), var(--accent-dark))', boxShadow: '0 0 30px rgba(249,115,22,0.4)' }}>
            Entrar na plataforma
          </Link>
          <Link href="/cadastro"
            className="w-full py-4 rounded-2xl font-bold text-base transition-all hover:scale-[1.02]"
            style={{ background: 'var(--bg-card2)', border: '1px solid #2a2a2a', color: 'var(--accent)' }}>
            Criar conta grátis
          </Link>
        </div>
      </div>
